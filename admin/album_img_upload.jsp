        ...
        if(email==null && session.getAttribute(email)==null){
            ...
            if(request.getParameter("code")!=null && request.getParameter("ccode")!=null){
                ...
                try
                {
                    ...
                    strProjectDir = request.getRealPath("album/"+code);
                    ...
                    fileOut.flush();
                    fileOut.close();
                    response.sendRedirect("album.jsp?ccode="+cat_code+"&acode="+code+"&album_success=1");
                }
                catch (Exception e){
                    response.sendRedirect("album.jsp?ccode="+cat_code+"&acode="+code+"&img_error=1");
                }
                }
                //response.sendRedirect("index.jsp");
            }
