...
<%
  try{
        ...
        if(email==null && session.getAttribute(email)==null){
            ...
            if(request.getParameter("ccode")!=null && request.getParameter("acode")!=null){
			...
			<div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="card text-white bg-primary mb-3">
                                    <div class="card-header">Change Album Image</div>
                                    <div class="card-body" style="background-color: whitesmoke">
                                        <form class="pt-3" method="post" action="album_img_upload.jsp?code=<%=album_code%>&ccode=<%=cat_code%>" ENCTYPE='multipart/form-data'>
