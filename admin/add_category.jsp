...
<%
        ...
        if(email!=null && session.getAttribute(email)!=null){
            if(request.getParameter("cat").length()!=0){
                ...
                try{
                    ...
                    ResultSet rs = st.executeQuery("select MAX(sn) from album_category");
                    if(rs.next()){
                         sn = rs.getInt(1);   
                    }
                    sn = sn + 1 ;
                    ...
                    ResultSet rs1 = st1.executeQuery("select * from album_category where category_name='"+cat+"'");
                    if(rs1.next()){
                        out.print("already");
                    }
                    else{
