                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <div class="container-fluid">
                                            <%
                                                if(request.getParameter("email_invalid")!=null){
                                                  out.println("<h6 class='alert alert-danger'>Invalid Email !</h6>");
                                                }
                                                  ...
                                                  out.println("<h6 class='alert alert-danger'>Invalid Password !</h6>");
                                                }
                                            %>
                                         </div>
